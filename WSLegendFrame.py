...
class WSLegendWindow(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.legend_title_label.grid(row=0, column=0, columnspan=2, sticky="nsew")
...
class TestLegendApp(ctk.CTk):
    def __init__(self):
        ...
        self.open_tl_button = ctk.CTkButton(self, text="Open Top Level")
        self.open_tl_button.pack()
        
        self.legend = WSLegendWindow(self)
        self.legend.pack()
        
        self.ws_legend_window = None
